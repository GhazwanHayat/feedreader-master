...
$(function () {
    ...
    */
    describe('RSS Feeds', function () {
         ...
         */
        it('URL defined & not empty', function getData(callback) {
         ...
         */
        it('Name defined & not empty', function getData(callback) {
            for (let i = 0; i < allFeeds.length; i++) {
    ...
    describe('The menu', function () {
         ...
         */
        it('check hiding/showing', function () {
    ...
    describe('Initial Entries', function () {
        ...
        it('Check a single .entry element within the .feed container.', function () {
            expect(document.querySelector('.entry .feed')).toBeDefined();
        });
